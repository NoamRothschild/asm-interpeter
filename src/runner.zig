...
pub fn run(allocator: std.mem.Allocator, ctx: *Context, code: []const u8) !void {
    var parser_result = parser.parse(allocator, code) catch |err| {
